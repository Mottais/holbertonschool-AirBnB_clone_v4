// .ready : pour s'assurer que le code de manipulation DOM
// s'exécute uniquement après le chargement HTML
$(document).ready(function() {
  let listeAmenitiesSelectionnees = {};

  // Fonction pour filtrer les places en fonction des critères
  function fetchPlaces(criteres) {
    $.ajax({
      ...
      success: function(data) {
        // Vider la section .places avant d'ajouter les nouveaux articles
        $('.places').empty();
